...
var restrictedMealPreferenceTags = map[string]map[string]bool{
	...
	"nut_free":     {"nuts_seeds": true},
	"vegetarian":   {"poultry": true, "pork": true, "lamb": true, "beef": true, "seafood": true},
	"vegan":        {"poultry": true, "beef": true, "pork": true, "lamb": true, "seafood": true, "eggs": true, "dairy": true},
	"halal":        {"pork": true},
	"non_beef":     {"beef": true},
}
